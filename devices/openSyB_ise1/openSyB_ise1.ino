...
const int port = 80;
const char *ACCESSKEY = "79c7679a70d20ce99f8a380ffdff31df41aba9c4";
const char *body = "[ACCESSKEY]79c7679a70d20ce99f8a380ffdff31df41aba9c4";
...
void mainframe() {
  ...
  if (myFile) {
    ...
    if (a3gs.connectTCP(server, port) != 0) {
      ...
      a3gs.write("[PLACE]Goriki Marine Village"); Serial.print("[PLACE]Goriki Marine Village");
