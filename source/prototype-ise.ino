...
const char *path = "/setup/cmd.s";
const int port = 80;
const char *USER_TOKEN = "openSy-ise1@tackie";
...
void mainframe() {
  ...
  Serial.println("");
    ...
    if (a3gs.httpGET(server, port, path, res, len) == 0) {
      ...
      Serial.print("[Failed] httpGET() from ");
      Serial.println(server);
    }
  ...
  if (myFile) {
    ...
    if (a3gs.connectTCP(server, port) != 0) {
      ...
      // Send POST request
      a3gs.write("POST /upload.php HTTP/1.0$n");
      a3gs.write("HOST: "); a3gs.write(server); a3gs.write("$n");
      // Arduino has a bug in multiparted HTTP-POSTing
      //a3gs.write("Content-Type: multipart/form-data; boundary=-----$n");
      a3gs.write("Content-Type: text/plain");
      a3gs.write("Connection: close$n");
      a3gs.write("Content-Length: "); a3gs.write("20000"); a3gs.write("$n$n");
      
      
      a3gs.write("TOKEN="); a3gs.write(USER_TOKEN); a3gs.write(";");
      a3gs.write("DATE=");  a3gs.write(date); a3gs.write(";");
      a3gs.write("TIME=");  a3gs.write(time); a3gs.write(";");
      a3gs.write("TEMP=");  a3gs.write(temparature); a3gs.write(";");
      Serial.print("TEMP=");  Serial.print(temparature); Serial.println(";");
      a3gs.write("HUMD=");  a3gs.write(humidity); a3gs.write(";");
      Serial.print("HUMD=");  Serial.print(humidity); Serial.println(";");
      a3gs.write("BRGT=");  a3gs.write(brightness); a3gs.write(";");
      Serial.print("BRGT=");  Serial.print(brightness); Serial.println(";");
      a3gs.write("PHOTOSTREAM=");
